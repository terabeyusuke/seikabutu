    ...
    <div class="container">
        ...
        @if (!is_null($headline))
                ...
                <div class="headline col-md-10 mx-auto">
                    <div class="row">
                        <div class="col-md-6">
                          ...
                          @if (Auth::check())
                            @if ($headline != null)
                                @if ($headline->like_by() == null)
                                   {{ Form::model($headline, array('action' => array('LikesController@store', $headline->id))) }}
                                      <button type="submit">
                                        <img scr="/images/icon_heart_red.svg">
                                        Like {{ $headline->likes_count }}
                                      </button>
                                  {{ Form::close() }}
                                  @else
                                      {{Form::model($headline, array('action' => array('LikesController@destroy',$headline->id, $headline->like_by()->id))) }}
                                      <button typw="submit">
            ...
            <div class="maine-comment">
              ...
              <label class="col-md-2" for="comment">コメント記入欄</lavel>
              <div class="col-md-10">
